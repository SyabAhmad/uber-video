...
const ConfirmRide = (props) => {
    console.log('Pickup location:', props.pickup);
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='w-full mt-5'>
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium'>{props.pickup || 'Pickup Location'}</h3>
                    ...
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium'>{props.destination || 'Destination'}</h3>
